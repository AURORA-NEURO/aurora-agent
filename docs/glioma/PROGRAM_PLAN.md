...
- Current implementation: 17/32 slots. Next wave: acquisition-result feedback into prospective
  streams, bounded multi-site execution handoff, and evidence-to-knowledge closure.
...
- Current implementation: 23/32 slots. Next wave: recovery/resume planning, action outcome
  assimilation, and claim-to-experiment closure.
...
- Current implementation: 4/32 slots. Next wave: multimodal object packaging, migration checks,
