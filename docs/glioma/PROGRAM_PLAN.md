...
- Current implementation: 27/32 slots. Next wave: long-horizon calibration, production federation
  of outcome summaries, and evidence-surveillance operating-cycle hardening.
