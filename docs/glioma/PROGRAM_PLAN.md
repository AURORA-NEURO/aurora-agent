...
- Current implementation: 16/32 slots. Next wave: evidence graph joins, acquisition-result
  feedback into prospective streams, and bounded multi-site execution handoff.
