...
- Current implementation: 13/32 slots. Next wave: evidence graph joins, claim-level novelty
  adjudication, and acquisition-result feedback into the autonomous director.
