...
- Current implementation: 26/32 slots. Next wave: bounded evidence-to-knowledge interaction,
  long-horizon calibration, and production federation of outcome summaries.
