...
test("brain throughput surveillance keeps capacity omission explicit", () => { const receipt = { schema_version: "aurora-research-contract/1.0", feature_id: HIGH_THROUGHPUT_EVIDENCE_SURVEILLANCE_FEATURE_ID, contract_version: HIGH_THROUGHPUT_EVIDENCE_SURVEILLANCE_CONTRACT_VERSION, request_id: "request:throughput", batch_id: "batch:001", partition: "partition:imaging", disposition: "partial", candidate_order: ["evidence:a", "evidence:b"], admitted_order: ["evidence:a"], blocked_order: ["evidence:b"], unknown_order: [], relevance_order: [900, 800], omissions: ["evidence:evidence:b:batch-capacity-exceeded"], uncertainty: [], negative_evidence: [], checkpoint_seq: 2, queue_digest: "a".repeat(64), replay_identity: "b".repeat(64), effect_receipts: ["read:local-research-artifacts:request:throughput"], artifact: { content_hash: "c".repeat(64) }, raw_data_local: true, boundary: PRECLINICAL_BOUNDARY }; assert.doesNotThrow(() => validateBrainHighThroughputEvidenceReceipt(receipt)); assert.equal(brainHighThroughputEvidenceReceiptDigest(receipt), brainHighThroughputEvidenceReceiptDigest(receipt)); });
test("brain federated surveillance keeps signer failure explicit", () => { const receipt = { schema_version: "aurora-research-contract/1.0", feature_id: FEDERATED_EVIDENCE_SURVEILLANCE_FEATURE_ID, contract_version: FEDERATED_EVIDENCE_SURVEILLANCE_CONTRACT_VERSION, request_id: "request:federation", federation_id: "federation:commons", institution_id: "institution:a", purpose: "benchmarking", semantic_profile: "preclinical-evidence/v1", endpoint: "https://hub.example/research", disposition: "blocked", candidate_order: ["evidence:a"], admitted_order: [], blocked_order: ["evidence:a"], unknown_order: [], aggregate_order: [], omissions: [], uncertainty: [], negative_evidence: ["request:signer-invalid"], replay_identity: "a".repeat(64), effect_receipts: ["block:unsafe-release"], artifact: { content_hash: "b".repeat(64) }, raw_data_local: true, boundary: PRECLINICAL_BOUNDARY }; assert.doesNotThrow(() => validateBrainFederatedEvidenceReceipt(receipt)); assert.equal(brainFederatedEvidenceReceiptDigest(receipt), brainFederatedEvidenceReceiptDigest(receipt)); });
test("brain evidence contract keeps missing field explicit", () => { const receipt = { schema_version: "aurora-research-contract/1.0", feature_id: EVIDENCE_CONTRACT_MODEL_FEATURE_ID, contract_version: EVIDENCE_CONTRACT_MODEL_CONTRACT_VERSION, request_id: "request:contract", study_id: "study:organoid", scope: "organoid:neural", disposition: "partial", compatibility: "additive", input_schema: "EvidenceFeed1@1", output_schema: "QualifiedEvidenceSet2@1", required_order: ["artifact_digest", "provenance_digest", "scope"], provided_order: ["provenance_digest", "scope"], missing_order: ["artifact_digest"], semantic_loss_order: [], semantic_digest: "a".repeat(64), artifact_digest: "b".repeat(64), provenance_digest: "c".repeat(64), contract_digest: "d".repeat(64), replay_identity: "e".repeat(64), omissions: ["field:artifact_digest:required-missing"], uncertainty: [], negative_evidence: [], effect_receipts: ["block:unsafe-release"], artifact: { content_hash: "f".repeat(64) }, raw_data_local: true, boundary: PRECLINICAL_BOUNDARY }; assert.doesNotThrow(() => validateBrainEvidenceContractModelReceipt(receipt)); assert.equal(brainEvidenceContractModelReceiptDigest(receipt), brainEvidenceContractModelReceiptDigest(receipt)); });
test("brain multimodal contract keeps semantic disagreement explicit", () => { const receipt = { schema_version: "aurora-research-contract/1.0", feature_id: MULTIMODAL_CONTRACT_MODEL_FEATURE_ID, contract_version: MULTIMODAL_CONTRACT_MODEL_CONTRACT_VERSION, request_id: "request:multimodal-contract", study_order: ["study:a", "study:b"], scope: "organoid:neural", comparability_profile: "preclinical-multimodal/v1", disposition: "partial", compatibility: "additive", input_schema: "EvidenceFeed2@1", output_schema: "QualifiedEvidenceSet2@1", modality_order: ["imaging", "transcriptomics"], binding_order: ["study:a:imaging", "study:a:transcriptomics", "study:b:imaging", "study:b:transcriptomics"], missing_order: [], semantic_disagreement_order: ["modality:imaging:semantic-digest-disagreement"], schema_order: ["imaging:ome-ngff/5", "transcriptomics:anndata/0.10"], unit_order: ["imaging:si", "transcriptomics:si"], coordinate_order: ["imaging:sample-relative", "transcriptomics:sample-relative"], semantic_order: ["a".repeat(64), "b".repeat(64), "c".repeat(64)], artifact_order: ["d".repeat(64)], provenance_order: ["e".repeat(64)], contract_digest: "f".repeat(64), replay_identity: "1".repeat(64), omissions: [], uncertainty: [], negative_evidence: ["modality:imaging:semantic-digest-disagreement"], effect_receipts: ["block:unsafe-release"], artifact: { content_hash: "2".repeat(64) }, raw_data_local: true, boundary: PRECLINICAL_BOUNDARY }; assert.doesNotThrow(() => validateBrainMultimodalContractModelReceipt(receipt)); assert.equal(brainMultimodalContractModelReceiptDigest(receipt), brainMultimodalContractModelReceiptDigest(receipt)); });
test("brain throughput contract keeps capacity overflow explicit", () => { const receipt = { schema_version: "aurora-research-contract/1.0", feature_id: THROUGHPUT_CONTRACT_MODEL_FEATURE_ID, contract_version: THROUGHPUT_CONTRACT_MODEL_CONTRACT_VERSION, request_id: "request:throughput-contract", batch_id: "batch:001", partition: "partition:imaging", disposition: "partial", compatibility: "additive", input_schema: "EvidenceFeed3@1", output_schema: "QualifiedEvidenceSet2@1", required_order: ["checkpoint", "queue_digest", "replay_identity"], provided_order: ["checkpoint", "queue_digest", "replay_identity"], missing_order: [], semantic_loss_order: [], max_items: 100, observed_items: 120, admitted_items: 100, checkpoint_seq: 3, queue_digest: "a".repeat(64), contract_digest: "b".repeat(64), replay_identity: "c".repeat(64), omissions: ["batch:batch:001:capacity-exceeded"], uncertainty: [], negative_evidence: [], effect_receipts: ["block:unsafe-release"], artifact: { content_hash: "d".repeat(64) }, raw_data_local: true, boundary: PRECLINICAL_BOUNDARY }; assert.doesNotThrow(() => validateBrainThroughputContractModelReceipt(receipt)); assert.equal(brainThroughputContractModelReceiptDigest(receipt), brainThroughputContractModelReceiptDigest(receipt)); });
test("brain federated contract keeps signer failure explicit", () => { const receipt = { schema_version: "aurora-research-contract/1.0", feature_id: FEDERATED_CONTRACT_MODEL_FEATURE_ID, contract_version: FEDERATED_CONTRACT_MODEL_CONTRACT_VERSION, request_id: "request:federated-contract", federation_id: "federation:commons", institution_id: "institution:a", purpose: "benchmarking", endpoint: "https://hub.example/research", semantic_profile: "preclinical-evidence/v1", disposition: "blocked", compatibility: "additive", input_schema: "EvidenceFeed4@1", output_schema: "QualifiedEvidenceSet2@1", required_order: ["contract_digest", "provenance_digest", "semantic_digest"], provided_order: ["contract_digest", "provenance_digest", "semantic_digest"], missing_order: [], semantic_loss_order: [], allowed_artifact_order: ["raw-data"], export_scope: "federation:commons:institution:a:benchmarking", semantic_digest: "a".repeat(64), provenance_digest: "b".repeat(64), contract_digest: "c".repeat(64), envelope_digest: "d".repeat(64), replay_identity: "e".repeat(64), omissions: ["federation:permitted-artifact-missing"], uncertainty: [], negative_evidence: ["request:signer-invalid"], effect_receipts: ["block:unsafe-release"], artifact: { content_hash: "f".repeat(64) }, raw_data_local: true, boundary: PRECLINICAL_BOUNDARY }; assert.doesNotThrow(() => validateBrainFederatedContractModelReceipt(receipt)); assert.equal(brainFederatedContractModelReceiptDigest(receipt), brainFederatedContractModelReceiptDigest(receipt)); });
test("brain evidence copilot keeps blocked action explicit", () => { const receipt = { schema_version: "aurora-research-contract/1.0", feature_id: EVIDENCE_RESEARCH_COPILOT_FEATURE_ID, contract_version: EVIDENCE_RESEARCH_COPILOT_CONTRACT_VERSION, request_id: "request:copilot", operator_id: "operator:researcher", study_id: "study:organoid", scope: "organoid:neural", disposition: "blocked", plan_order: ["plan:inspect:evidence:a"], action_order: ["action:inspect:evidence:a"], candidate_order: ["evidence:a"], qualified_order: [], blocked_order: ["evidence:a"], unknown_order: [], evidence_receipt_digest: "a".repeat(64), plan_digest: "b".repeat(64), replay_identity: "c".repeat(64), budget_units: 1, omissions: [], uncertainty: [], negative_evidence: ["copilot:inspect-local-evidence-not-allowed"], effect_receipts: ["block:unsafe-release"], artifact: { content_hash: "d".repeat(64) }, raw_data_local: true, boundary: PRECLINICAL_BOUNDARY }; assert.doesNotThrow(() => validateBrainEvidenceResearchCopilotReceipt(receipt)); assert.equal(brainEvidenceResearchCopilotReceiptDigest(receipt), brainEvidenceResearchCopilotReceiptDigest(receipt)); });
test("brain multimodal copilot keeps tool denial explicit", () => { const receipt = { schema_version: "aurora-research-contract/1.0", feature_id: MULTIMODAL_EVIDENCE_COPILOT_FEATURE_ID, contract_version: MULTIMODAL_EVIDENCE_COPILOT_CONTRACT_VERSION, request_id: "request:multimodal-copilot", operator_id: "operator:researcher", study_order: ["study:a", "study:b"], scope: "organoid:neural", disposition: "blocked", plan_order: ["plan:inspect-multimodal:evidence:a"], action_order: ["action:inspect-multimodal:evidence:a"], tool_order: ["tool:multimodal-evidence"], candidate_order: ["evidence:a"], qualified_order: ["evidence:a"], blocked_order: [], unknown_order: [], modality_order: ["imaging"], evidence_receipt_digest: "a".repeat(64), plan_digest: "b".repeat(64), approval_reference: "c".repeat(64), replay_identity: "d".repeat(64), budget_units: 1, omissions: [], uncertainty: [], negative_evidence: ["copilot:inspect-local-multimodal-evidence-not-allowed"], effect_receipts: ["block:unsafe-release"], artifact: { content_hash: "e".repeat(64) }, raw_data_local: true, boundary: PRECLINICAL_BOUNDARY }; assert.doesNotThrow(() => validateBrainMultimodalEvidenceResearchCopilotReceipt(receipt)); assert.equal(brainMultimodalEvidenceResearchCopilotReceiptDigest(receipt), brainMultimodalEvidenceResearchCopilotReceiptDigest(receipt)); });
test("brain throughput copilot keeps capacity block explicit", () => { const receipt = { schema_version: "aurora-research-contract/1.0", feature_id: HIGH_THROUGHPUT_EVIDENCE_COPILOT_FEATURE_ID, contract_version: HIGH_THROUGHPUT_EVIDENCE_COPILOT_CONTRACT_VERSION, request_id: "request:throughput-copilot", operator_id: "operator:researcher", batch_id: "batch:001", partition: "partition:imaging", checkpoint_seq: 2, disposition: "blocked", plan_order: ["plan:checkpoint:2"], action_order: ["action:checkpoint:2"], tool_order: ["tool:throughput-evidence"], candidate_order: ["evidence:a"], admitted_order: ["evidence:a"], blocked_order: [], unknown_order: [], queue_digest: "a".repeat(64), evidence_receipt_digest: "b".repeat(64), plan_digest: "c".repeat(64), approval_reference: "d".repeat(64), replay_identity: "e".repeat(64), budget_units: 1, omissions: ["copilot:action-budget-exhausted"], uncertainty: [], negative_evidence: [], effect_receipts: ["block:unsafe-release"], artifact: { content_hash: "f".repeat(64) }, raw_data_local: true, boundary: PRECLINICAL_BOUNDARY }; assert.doesNotThrow(() => validateBrainHighThroughputEvidenceResearchCopilotReceipt(receipt)); assert.equal(brainHighThroughputEvidenceResearchCopilotReceiptDigest(receipt), brainHighThroughputEvidenceResearchCopilotReceiptDigest(receipt)); });
test("brain federated copilot keeps signer block explicit", () => { const receipt = { schema_version: "aurora-research-contract/1.0", feature_id: FEDERATED_EVIDENCE_COPILOT_FEATURE_ID, contract_version: FEDERATED_EVIDENCE_COPILOT_CONTRACT_VERSION, request_id: "request:federated-copilot", operator_id: "operator:researcher", federation_id: "federation:commons", institution_id: "institution:a", purpose: "benchmarking", semantic_profile: "preclinical-evidence/v1", endpoint: "https://hub.example/research", disposition: "blocked", plan_order: ["plan:exchange-permitted-summary"], action_order: ["action:exchange-permitted-summary"], tool_order: ["tool:federated-evidence"], candidate_order: ["evidence:a"], admitted_order: ["evidence:a"], blocked_order: [], unknown_order: [], aggregate_order: ["a".repeat(64)], envelope_digest: "b".repeat(64), evidence_receipt_digest: "c".repeat(64), plan_digest: "d".repeat(64), approval_reference: "e".repeat(64), replay_identity: "f".repeat(64), budget_units: 1, omissions: ["federation:permitted-artifact-missing"], uncertainty: [], negative_evidence: ["request:signer-invalid"], effect_receipts: ["block:unsafe-release"], artifact: { content_hash: "1".repeat(64) }, raw_data_local: true, boundary: PRECLINICAL_BOUNDARY }; assert.doesNotThrow(() => validateBrainFederatedEvidenceResearchCopilotReceipt(receipt)); assert.equal(brainFederatedEvidenceResearchCopilotReceiptDigest(receipt), brainFederatedEvidenceResearchCopilotReceiptDigest(receipt)); });
test("brain evidence workflow keeps compensation explicit", () => { const receipt = { schema_version: "aurora-research-contract/1.0", feature_id: EVIDENCE_WORKFLOW_FABRIC_FEATURE_ID, contract_version: EVIDENCE_WORKFLOW_FABRIC_CONTRACT_VERSION, request_id: "request:workflow", workflow_id: "workflow:evidence", study_id: "study:organoid", scope: "organoid:neural", disposition: "unknown", stage_order: ["stage:checkpoint", "stage:surveil-evidence", "stage:validate-input"], plan_order: ["plan:retain-unknown-evidence", "plan:stage:checkpoint", "plan:stage:surveil-evidence", "plan:stage:validate-input"], completed_order: ["stage:checkpoint", "stage:surveil-evidence", "stage:validate-input"], blocked_order: ["evidence:a"], compensation_order: ["compensate:research-work:retain-unresolved-evidence"], candidate_order: ["evidence:a"], qualified_order: [], unknown_order: ["evidence:a"], evidence_receipt_digest: "a".repeat(64), checkpoint_digest: "b".repeat(64), workflow_digest: "c".repeat(64), replay_identity: "d".repeat(64), budget_units: 8, omissions: ["workflow:no-qualified-evidence-to-schedule"], uncertainty: [], negative_evidence: [], effect_receipts: ["compensate:research-work:workflow:evidence"], artifact: { content_hash: "e".repeat(64) }, raw_data_local: true, boundary: PRECLINICAL_BOUNDARY }; assert.doesNotThrow(() => validateBrainEvidenceWorkflowFabricReceipt(receipt)); assert.equal(brainEvidenceWorkflowFabricReceiptDigest(receipt), brainEvidenceWorkflowFabricReceiptDigest(receipt)); });
test("brain multimodal workflow keeps modality compensation explicit", () => { const receipt = { schema_version: "aurora-research-contract/1.0", feature_id: MULTIMODAL_EVIDENCE_WORKFLOW_FABRIC_FEATURE_ID, contract_version: MULTIMODAL_EVIDENCE_WORKFLOW_FABRIC_CONTRACT_VERSION, request_id: "request:multimodal-workflow", workflow_id: "workflow:multimodal", scope: "organoid:neural", study_order: ["study:a", "study:b"], modality_order: ["imaging", "transcriptomics"], disposition: "partial", stage_order: ["stage:checkpoint", "stage:compare-modalities", "stage:surveil-evidence", "stage:validate-input"], plan_order: ["plan:publish-qualified-multimodal-artifact", "plan:stage:checkpoint", "plan:stage:compare-modalities", "plan:stage:surveil-evidence", "plan:stage:validate-input"], completed_order: ["stage:checkpoint", "stage:compare-modalities", "stage:surveil-evidence", "stage:validate-input"], blocked_order: [], compensation_order: ["compensate:research-work:retain-incomplete-modalities"], candidate_order: ["evidence:a"], qualified_order: ["evidence:a"], unknown_order: [], evidence_receipt_digest: "a".repeat(64), checkpoint_digest: "b".repeat(64), workflow_digest: "c".repeat(64), comparability_digest: "d".repeat(64), approval_reference: "e".repeat(64), replay_identity: "f".repeat(64), budget_units: 8, omissions: ["modality:transcriptomics:required-coverage-missing"], uncertainty: [], negative_evidence: [], effect_receipts: ["compensate:research-work:workflow:multimodal"], artifact: { content_hash: "1".repeat(64) }, raw_data_local: true, boundary: PRECLINICAL_BOUNDARY }; assert.doesNotThrow(() => validateBrainMultimodalEvidenceWorkflowFabricReceipt(receipt)); assert.equal(brainMultimodalEvidenceWorkflowFabricReceiptDigest(receipt), brainMultimodalEvidenceWorkflowFabricReceiptDigest(receipt)); });
test("brain throughput workflow keeps capacity compensation explicit", () => { const receipt = { schema_version: "aurora-research-contract/1.0", feature_id: HIGH_THROUGHPUT_EVIDENCE_WORKFLOW_FABRIC_FEATURE_ID, contract_version: HIGH_THROUGHPUT_EVIDENCE_WORKFLOW_FABRIC_CONTRACT_VERSION, request_id: "request:throughput-workflow", workflow_id: "workflow:throughput", batch_id: "batch:001", partition: "partition:imaging", disposition: "partial", stage_order: ["stage:admit-batch", "stage:checkpoint", "stage:persist-queue", "stage:validate-input"], plan_order: ["plan:publish-admitted-batch", "plan:stage:admit-batch", "plan:stage:checkpoint", "plan:stage:persist-queue", "plan:stage:validate-input"], completed_order: ["stage:admit-batch", "stage:checkpoint", "stage:persist-queue", "stage:validate-input"], blocked_order: ["evidence:b"], compensation_order: ["compensate:research-work:capacity-overflow"], candidate_order: ["evidence:a", "evidence:b"], admitted_order: ["evidence:a"], unknown_order: [], checkpoint_seq: 2, queue_digest: "a".repeat(64), checkpoint_digest: "b".repeat(64), workflow_digest: "c".repeat(64), approval_reference: "d".repeat(64), replay_identity: "e".repeat(64), budget_units: 8, omissions: ["workflow:capacity-overflow-requires-compensation"], uncertainty: [], negative_evidence: [], effect_receipts: ["compensate:research-work:workflow:throughput"], artifact: { content_hash: "f".repeat(64) }, raw_data_local: true, boundary: PRECLINICAL_BOUNDARY }; assert.doesNotThrow(() => validateBrainHighThroughputEvidenceWorkflowFabricReceipt(receipt)); assert.equal(brainHighThroughputEvidenceWorkflowFabricReceiptDigest(receipt), brainHighThroughputEvidenceWorkflowFabricReceiptDigest(receipt)); });
test("brain federated workflow keeps partial exchange compensation explicit", () => { const receipt = { schema_version: "aurora-research-contract/1.0", feature_id: FEDERATED_EVIDENCE_WORKFLOW_FABRIC_FEATURE_ID, contract_version: FEDERATED_EVIDENCE_WORKFLOW_FABRIC_CONTRACT_VERSION, request_id: "request:federated-workflow", workflow_id: "workflow:federated", federation_id: "federation:commons", institution_id: "institution:a", purpose: "benchmarking", endpoint: "https://hub.example/research", disposition: "partial", stage_order: ["stage:admit-federation", "stage:checkpoint", "stage:publish-aggregate", "stage:validate-input"], plan_order: ["plan:publish-permitted-aggregate", "plan:stage:admit-federation", "plan:stage:checkpoint", "plan:stage:publish-aggregate", "plan:stage:validate-input"], completed_order: ["stage:admit-federation", "stage:checkpoint", "stage:publish-aggregate", "stage:validate-input"], blocked_order: ["evidence:b"], compensation_order: ["compensate:research-work:federation-partial"], candidate_order: ["evidence:a", "evidence:b"], admitted_order: ["evidence:a"], unknown_order: [], aggregate_order: ["a".repeat(64)], checkpoint_digest: "b".repeat(64), workflow_digest: "c".repeat(64), approval_reference: "d".repeat(64), replay_identity: "e".repeat(64), budget_units: 8, omissions: ["workflow:federation-partial-requires-compensation"], uncertainty: [], negative_evidence: [], effect_receipts: ["compensate:research-work:workflow:federated"], artifact: { content_hash: "f".repeat(64) }, raw_data_local: true, boundary: PRECLINICAL_BOUNDARY }; assert.doesNotThrow(() => validateBrainFederatedEvidenceWorkflowFabricReceipt(receipt)); assert.equal(brainFederatedEvidenceWorkflowFabricReceiptDigest(receipt), brainFederatedEvidenceWorkflowFabricReceiptDigest(receipt)); });
test("brain evidence workbench keeps read-only view explicit", () => { const receipt = { schema_version: "aurora-research-contract/1.0", feature_id: EVIDENCE_RESEARCH_WORKBENCH_FEATURE_ID, contract_version: EVIDENCE_RESEARCH_WORKBENCH_CONTRACT_VERSION, request_id: "request:workbench", workspace_id: "workspace:brain", study_id: "study:organoid", scope: "organoid:neural", disposition: "qualified", view_order: ["view:evidence-table", "view:omission-audit", "view:source-lineage"], panel_order: ["panel:evidence", "panel:lineage"], action_receipts: ["action:render-evidence-table", "action:render-omission-audit", "action:render-source-lineage"], candidate_order: ["evidence:a"], qualified_order: ["evidence:a"], blocked_order: [], unknown_order: [], evidence_digest: "a".repeat(64), workbench_digest: "b".repeat(64), replay_identity: "c".repeat(64), budget_units: 8, omissions: [], uncertainty: [], negative_evidence: [], effect_receipts: ["view:local-research-artifacts:workspace:brain"], artifact: { content_hash: "d".repeat(64) }, raw_data_local: true, boundary: PRECLINICAL_BOUNDARY }; assert.doesNotThrow(() => validateBrainEvidenceResearchWorkbenchReceipt(receipt)); assert.equal(brainEvidenceResearchWorkbenchReceiptDigest(receipt), brainEvidenceResearchWorkbenchReceiptDigest(receipt)); });
test("brain multimodal workbench keeps modality coverage explicit", () => { const receipt = { schema_version: "aurora-research-contract/1.0", feature_id: MULTIMODAL_RESEARCH_WORKBENCH_FEATURE_ID, contract_version: MULTIMODAL_RESEARCH_WORKBENCH_CONTRACT_VERSION, request_id: "request:multimodal-workbench", workspace_id: "workspace:multimodal", scope: "organoid:neural", study_order: ["study:a", "study:b"], modality_order: ["imaging", "transcriptomics"], disposition: "partial", view_order: ["view:comparability-matrix", "view:modality-coverage", "view:source-lineage"], panel_order: ["panel:coverage", "panel:lineage"], action_receipts: ["action:render-comparability-matrix", "action:render-modality-coverage", "action:render-source-lineage"], candidate_order: ["evidence:a"], qualified_order: ["evidence:a"], blocked_order: [], unknown_order: [], evidence_digest: "a".repeat(64), comparability_digest: "b".repeat(64), workbench_digest: "c".repeat(64), replay_identity: "d".repeat(64), budget_units: 8, omissions: ["modality:transcriptomics:required-coverage-missing"], uncertainty: [], negative_evidence: [], effect_receipts: ["view:local-multimodal-artifacts:workspace:multimodal"], artifact: { content_hash: "e".repeat(64) }, raw_data_local: true, boundary: PRECLINICAL_BOUNDARY }; assert.doesNotThrow(() => validateBrainMultimodalResearchWorkbenchReceipt(receipt)); assert.equal(brainMultimodalResearchWorkbenchReceiptDigest(receipt), brainMultimodalResearchWorkbenchReceiptDigest(receipt)); });
test("brain throughput workbench keeps capacity visible", () => { const receipt = { schema_version: "aurora-research-contract/1.0", feature_id: THROUGHPUT_RESEARCH_WORKBENCH_FEATURE_ID, contract_version: THROUGHPUT_RESEARCH_WORKBENCH_CONTRACT_VERSION, request_id: "request:throughput-workbench", workspace_id: "workspace:throughput", batch_id: "batch:001", partition: "partition:imaging", disposition: "partial", view_order: ["view:capacity-frontier", "view:checkpoint-replay", "view:queue-monitor"], panel_order: ["panel:capacity", "panel:replay"], action_receipts: ["action:render-capacity-frontier", "action:render-checkpoint-replay", "action:render-queue-monitor"], candidate_order: ["evidence:a", "evidence:b"], admitted_order: ["evidence:a"], blocked_order: ["evidence:b"], unknown_order: [], checkpoint_seq: 2, queue_digest: "a".repeat(64), evidence_digest: "b".repeat(64), workbench_digest: "c".repeat(64), replay_identity: "d".repeat(64), budget_units: 8, omissions: ["evidence:evidence:b:batch-capacity-exceeded"], uncertainty: [], negative_evidence: [], effect_receipts: ["view:local-throughput-artifacts:workspace:throughput"], artifact: { content_hash: "e".repeat(64) }, raw_data_local: true, boundary: PRECLINICAL_BOUNDARY }; assert.doesNotThrow(() => validateBrainThroughputResearchWorkbenchReceipt(receipt)); assert.equal(brainThroughputResearchWorkbenchReceiptDigest(receipt), brainThroughputResearchWorkbenchReceiptDigest(receipt)); });
