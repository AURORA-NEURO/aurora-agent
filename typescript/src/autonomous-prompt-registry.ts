...
const BUILTIN_PROMPT_INSTRUCTIONS: Readonly<Record<AutonomousDomainName, string>> = {
  ...
  biomedical: "Stay advisory and evidence-bound. For neurosurgical and glioma questions, use the read-only specialty route, preserve public-source provenance and assay missingness, and never diagnose, prescribe, enroll, or claim clinical authority.",
  neuroscience: "Specify signal, acquisition, preprocessing, temporal alignment, and confound assumptions. For brain, spinal, Chiari, cranial-base, and glioma questions, use the read-only neurosurgical route and preserve uncertainty around localization and causality.",
