"""Python parity surface for AFA-worldgen-P01-F24."""
...
from .worldgen_federated_continual_evidence_surveillance_research_workbench import render_federated_continual_evidence_surveillance_research_workbench
from .research_contracts import PRECLINICAL_BOUNDARY, RESEARCH_CONTRACT_SCHEMA_VERSION, ResearchContractError, research_artifact_digest

FEATURE_ID = "AFA-worldgen-P01-F24"
CONTRACT_VERSION = "worldgen-federated-continual-evidence-surveillance-interoperability-gateway/1.0"
...
class FederatedContinualEvidenceSurveillanceInteroperabilityGatewayReceipt:
...
def render_federated_continual_evidence_surveillance_interoperability_gateway(*, protocol: Mapping[str, Any], workbench_kwargs: Mapping[str, Any], requested_input_schema: str = INPUT_SCHEMA, requested_output_schema: str = OUTPUT_SCHEMA, migration_policy: str = "additive-minor-with-loss-receipt", semantic_loss_budget: int = 4, boundary: str = PRECLINICAL_BOUNDARY) -> FederatedContinualEvidenceSurveillanceInteroperabilityGatewayReceipt:
    ...
    wb = render_federated_continual_evidence_surveillance_research_workbench(**dict(workbench_kwargs))
