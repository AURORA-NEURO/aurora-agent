"""Parity contract for AFA-worldgen-P01-F28 federated continual evidence surveillance assurance."""
...
FEATURE_ID = "AFA-worldgen-P01-F28"
CONTRACT_VERSION = "worldgen-federated-continual-evidence-surveillance-assurance/1.0"
CONTENT_TYPE = "application/vnd.aurora.worldgen-qualified-evidence-set-7+json"
...
def worldgen_federated_continual_evidence_surveillance_assurance_manifest() -> dict[str, Any]:
    return {"schema_version": RESEARCH_CONTRACT_SCHEMA_VERSION, "capability_id": FEATURE_ID, "version": CONTRACT_VERSION, "owner_crate": "worldgen", "input_schema": "EvidenceFeed4@1", "output_schema": "QualifiedEvidenceSet7@1", "autonomy_tier": "A1", "determinism": "byte_stable", "boundary": PRECLINICAL_BOUNDARY}

influence_local_evidence_surveillance_manifest = worldgen_federated_continual_evidence_surveillance_assurance_manifest
...
worldgen_assure_federated_continual_evidence_surveillance = assure_local_evidence_surveillance
__all__ += ["worldgen_federated_continual_evidence_surveillance_assurance_manifest", "worldgen_assure_federated_continual_evidence_surveillance"]
