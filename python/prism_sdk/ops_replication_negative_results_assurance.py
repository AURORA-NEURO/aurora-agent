"""Python parity surface for ``AFA-ops-P15-F28``."""
...
FEATURE_ID="AFA-ops-P15-F28"; CONTRACT_VERSION="ops-federated-continual-replication-negative-results-assurance-harness/1.0"; INPUT_SCHEMA="ClaimAndProtocol4@1"; OUTPUT_SCHEMA="ReplicationRecord7@1"; CONTENT_TYPE="application/vnd.aurora.replication-record-7+json"
...
def replication_negative_results_manifest()->dict[str,Any]:return {"schema_version":RESEARCH_CONTRACT_SCHEMA_VERSION,"capability_id":FEATURE_ID,"version":CONTRACT_VERSION,"owner_crate":"ops","consumers":["research data steward","replication lead","consortium operator"],"behavior":"verifies federated replication claims and retains null or failed outcomes as typed evidence without converting them into positive conclusions","value":"makes reproducibility, contradiction, negative results, omissions, and policy boundaries auditable before research-object release","input_schema":INPUT_SCHEMA,"output_schema":OUTPUT_SCHEMA,"effects":["execute_local_computation","write_local_artifact","federation_export"],"autonomy_tier":"A1","boundary":PRECLINICAL_BOUNDARY}
