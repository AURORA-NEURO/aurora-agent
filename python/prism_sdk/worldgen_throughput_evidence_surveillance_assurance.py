"""Parity contract for AFA-worldgen-P01-F27 throughput evidence surveillance assurance."""
...
FEATURE_ID = "AFA-worldgen-P01-F27"
CONTRACT_VERSION = "worldgen-throughput-evidence-surveillance-assurance/1.0"
...
def worldgen_throughput_evidence_surveillance_assurance_manifest() -> dict[str, Any]:
    return {"schema_version": RESEARCH_CONTRACT_SCHEMA_VERSION, "capability_id": FEATURE_ID, "version": CONTRACT_VERSION, "owner_crate": "worldgen", "input_schema": "EvidenceFeed3@1", "output_schema": "QualifiedEvidenceSet7@1", "autonomy_tier": "A1", "determinism": "byte_stable", "boundary": PRECLINICAL_BOUNDARY}

influence_local_evidence_surveillance_manifest = worldgen_throughput_evidence_surveillance_assurance_manifest
...
worldgen_assure_throughput_evidence_surveillance = assure_local_evidence_surveillance
__all__ += ["worldgen_throughput_evidence_surveillance_assurance_manifest", "worldgen_assure_throughput_evidence_surveillance"]
