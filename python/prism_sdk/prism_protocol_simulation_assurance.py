"""Multimodal multi-study protocol simulation assurance for ``AFA-prism-P10-F26``."""
...
FEATURE_ID = "AFA-prism-P10-F26"
CONTRACT_VERSION = "prism-multimodal-multi-study-protocol-simulation-assurance/1.0"
INPUT_SCHEMA = "ProtocolDraft2@1"
...
class FederatedProtocolSimulationReport:
    ...
    def validate(self) -> None:
        ...
        if any(not effect.startswith("verify:prism-protocol-simulation:") and effect != "block:unsafe-release" for effect in self.effect_receipts): raise ResearchContractError("federated protocol effect is outside verification gate")
