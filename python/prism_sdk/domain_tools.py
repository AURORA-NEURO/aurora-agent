...
def builtin_autonomous_domain_tool_profiles() -> tuple[AutonomousDomainToolProfile, ...]:
    ...
    return (
        ...
        _profile(
            ...
            (
                ("neurosurgery_catalogue", "neurosurgical_specialty_discovery"),
                ("neurosurgery_intake_plan", "neurosurgical_intake_routing"),
                ("neurosurgery_intake_mission", "neurosurgical_intake_routing"),
                ("neurosurgery_intake_portfolio", "neurosurgical_intake_routing"),
                ("neurosurgery_evidence_audit", "neurosurgical_evidence_audit"),
                ...
                ("neurosurgery_case_fhir_import", "neurosurgical_case_fhir_import"),
                ...
                ("neurosurgery_evidence_synthesis", "neurosurgical_evidence_synthesis"),
                ("neurosurgery_glioma_molecular_map", "neurosurgical_glioma_molecular_map"),
                ("neurosurgery_evidence_graph", "neurosurgical_evidence_graph"),
                ("neurosurgery_real_data_coverage", "neurosurgical_real_data_coverage"),
                ("neurosurgery_real_data_reconciliation", "neurosurgical_real_data_reconciliation"),
                ("neurosurgery_real_data_freshness", "neurosurgical_real_data_freshness"),
                ("neurosurgery_real_data_diff", "neurosurgical_real_data_diff"),
                ("neurosurgery_real_data_refresh_audit", "neurosurgical_real_data_refresh_audit"),
                ("neurosurgery_real_data_review_queue", "neurosurgical_real_data_review_queue"),
                ("neurosurgery_real_data_review_disposition", "neurosurgical_real_data_review_disposition"),
                ...
                ("neurosurgery_public_literature_refresh_audit", "neurosurgical_public_literature_refresh_audit"),
                ("neurosurgery_literature_link_audit", "neurosurgical_literature_link_audit"),
                ("neurosurgery_public_literature_integrity_audit", "neurosurgical_public_literature_integrity_audit"),
                ("neurosurgery_public_literature_review_queue", "neurosurgical_public_literature_review_queue"),
                ("neurosurgery_public_literature_workbench", "neurosurgical_public_literature_workbench"),
                ("neurosurgery_public_literature_portfolio", "neurosurgical_public_literature_portfolio"),
                ("neurosurgery_research_brief", "neurosurgical_research_brief"),
                ("neurosurgery_research_plan", "neurosurgical_research_plan"),
                ("neurosurgery_evidence_acquisition", "neurosurgical_evidence_acquisition"),
                ("neurosurgery_evidence_program", "neurosurgical_evidence_program"),
                ("neurosurgery_plan", "neurosurgical_research_route"),
                ("neurosurgery_real_data_query", "neurosurgical_public_data_query"),
                ("neurosurgery_real_data_trial_landscape", "neurosurgical_trial_landscape"),
                ("neurosurgery_real_data_molecular_coverage", "neurosurgical_molecular_coverage"),
                ("neurosurgery_public_literature_query", "neurosurgical_public_literature_query"),
                ("neurosurgery_session", "neurosurgical_resumable_session"),
                ("neurosurgery_mission", "neurosurgical_research_mission"),
...
class AutonomousDomainToolRuntime:
    ...
    def __init__(
        ...
        *,
        ...
        if authorization_context is not None and not callable(getattr(authorization_context, "authorize_operation", None)):
            raise ArgumentError("domain tool runtime authorization_context must be an AutonomousAuthorizationContext or None")
    ...
    def scoped(self, *, execution_id: str, domain: str, authorization_context: AutonomousAuthorizationContext | None = None) -> "AutonomousDomainToolRuntime":
        ...
        return AutonomousDomainToolRuntime(
            ...
            authorization_context=self.authorization_context if authorization_context is None else authorization_context,
    ...
    def __call__(self, calls: tuple[ProviderToolCall, ...]) -> tuple[ProviderToolResult, ...]:
        ...
        for call, tool, arguments, arguments_digest in prepared:
            try:
                if self.authorization_context is not None and tool.read_only:
                    self.authorization_context.authorize_operation(
                        operation="tool_execution",
                        domain=domain,
                        capability=tool.capability,
                        risk_class=tool.risk_class,
                        resource_digest=content_digest({"tool": tool.name, "call_id": call.call_id, "arguments_digest": arguments_digest}),
                    )
                if self.effect_boundary is not None and not tool.read_only:
                    output = self.effect_boundary.execute(
                        ...
                        authorization_domains=None if domain is None else (domain,),
                        authorization_capability=tool.capability,
                    )
                else:
                    if self.authorization_context is not None and not tool.read_only:
                        self.authorization_context.authorize_operation(
                ...
                # Authorization refusal is a control-plane outcome, not an executor failure.
                # Import lazily because the authorization module imports this module for the
                # canonical domain list; the runtime is fully initialized by this point.
                from .autonomous_authorization import AutonomousAuthorizationError

                if isinstance(error, AutonomousAuthorizationError):
                    results.append(
                        self._result(
                            call,
                            status="authorization_required",
                            content={"status": "authorization_required", "tool": tool.name, "secret_material": "never_returned"},
                            approved=False,
                            receipt=AutonomousDomainToolReceipt(
                                call.call_id,
                                tool.name,
