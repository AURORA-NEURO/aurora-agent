...
FEATURE_ID = "AFA-policy-P32-F07"
CONTRACT_VERSION = "policy-multimodal-grant-integrity-research_copilot/1.0"
def policy_multimodal_grant_integrity_research_copilot_manifest() -> dict[str, Any]:
...
def qualify_policy_multimodal_grant_integrity_research_copilot(request: Mapping[str, Any]) -> dict[str, Any]:
