    ...
    def do_GET(self) -> None:  # noqa: N802
        if self.path == "/healthz":
            ...
            self._send(200, {
                ...
                "reconciliation_summary": {"ok": True, "schema": "bioprism-devplat-domain-workflow-reconciliation-summary/0.1", "workflow": "domain_workflow_reconciliation_summary", "registry_generation": 1, "registry_size": 1, "completion_status_counts": {"complete": 1}, "ready_count": 1, "review_required_count": 1, "integrity_invalid_count": 0, "evidence_invalid_count": 0, "execution": "not_started", "readiness_claimed": False, "guarantees": ["bounded"], "limitations": ["audit only"]},
