...
#[test]
fn the_four_buckets_are_three_five_eight_and_four() {
    assert_eq!(verdict_counts(), [3, 5, 8, 4]);
...
#[test]
fn the_foreign_census_and_the_classification_name_the_same_five_subjects() {
