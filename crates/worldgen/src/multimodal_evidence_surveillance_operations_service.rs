//! Multimodal multi-study operations/federation capability (`AFA-worldgen-P01-F30`).
use super::operations_support::{self};
pub use super::operations_support::{OperationsReceipt, OperationsRequest};
pub const FEATURE_ID: &str = "AFA-worldgen-P01-F30";
pub const CONTRACT_VERSION: &str = "worldgen-multimodal-evidence-surveillance-operations/1.0";
pub const INPUT_SCHEMA: &str = "EvidenceFeed2@1";
pub const OUTPUT_SCHEMA: &str = "QualifiedEvidenceSet8@1";
pub const SCALE: &str = "multimodal multi-study";
pub fn worldgen_multimodal_evidence_surveillance_operations_manifest() -> serde_json::Value {
...
pub fn operate_worldgen_multimodal_evidence_surveillance(
...
mod tests {
    ...
    fn r() -> OperationsRequest {
        OperationsRequest {
            ...
            operator: "research program lead".into(),
            scope: "study:multi".into(),
            scale: SCALE.into(),
    ...
    fn qualified() {
        assert_eq!(
            operate_worldgen_multimodal_evidence_surveillance(&r())
                .unwrap()
                .disposition,
