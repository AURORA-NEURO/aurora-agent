//! Worldgen evidence-surveillance interoperability support.
//!
//! Private support module for worldgen P01 interoperability gateways.
//!
...
pub const FEATURE_ID: &str = "AFA-worldgen-internal-interoperability";
pub const CONTRACT_VERSION: &str = "worldgen-internal-interoperability/1.0";
