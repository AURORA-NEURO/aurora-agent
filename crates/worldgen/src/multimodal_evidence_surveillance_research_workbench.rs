//! Multimodal multi-study evidence-surveillance researcher workbench (AFA-worldgen-P01-F18).
...
pub const FEATURE_ID: &str = "AFA-worldgen-P01-F18";
pub const CONTRACT_VERSION: &str =
    "worldgen-multimodal-evidence-surveillance-research-workbench/1.0";
...
> {
    ...
    let artifact = TypedResearchArtifact::from_payload(
        format!(
            "worldgen-multimodal-evidence-workbench:{}",
