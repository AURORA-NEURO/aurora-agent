...
//!
//! Atlas feature: `AFA-worldgen-P01-F25`.
//!
...
pub const FEATURE_ID: &str = "AFA-worldgen-P01-F25";
pub const CONTRACT_VERSION: &str = "worldgen-local-evidence-surveillance-assurance/1.0";
...
pub fn worldgen_local_evidence_surveillance_assurance_manifest() -> CapabilityManifest {
    CapabilityManifest {
...
pub fn assure_worldgen_local_evidence_surveillance(
...
// Kept private to this module's historical tests; the crate-level exports use the worldgen names.
use assure_worldgen_local_evidence_surveillance as assure_local_evidence_surveillance;
use worldgen_local_evidence_surveillance_assurance_manifest as influence_local_evidence_surveillance_manifest;
