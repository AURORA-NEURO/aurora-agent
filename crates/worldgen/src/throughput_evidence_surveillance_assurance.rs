...
//!
//! Atlas feature: `AFA-worldgen-P01-F27`.
//!
...
pub const FEATURE_ID: &str = "AFA-worldgen-P01-F27";
pub const CONTRACT_VERSION: &str = "worldgen-throughput-evidence-surveillance-assurance/1.0";
...
pub fn worldgen_throughput_evidence_surveillance_assurance_manifest() -> CapabilityManifest {
    CapabilityManifest {
...
pub fn assure_worldgen_throughput_evidence_surveillance(
...
use assure_worldgen_throughput_evidence_surveillance as assure_local_evidence_surveillance;
use worldgen_throughput_evidence_surveillance_assurance_manifest as influence_local_evidence_surveillance_manifest;
