...
//! Atlas feature `AFA-worldgen-P01-F20`: an A1 read-only view over signed,
...
pub const FEATURE_ID: &str = "AFA-worldgen-P01-F20";
pub const CONTRACT_VERSION: &str =
    "worldgen-federated-continual-evidence-surveillance-research-workbench/1.0";
...
> {
    ...
    let artifact = TypedResearchArtifact::from_payload(
        format!(
            "worldgen-federated-evidence-workbench:{}",
