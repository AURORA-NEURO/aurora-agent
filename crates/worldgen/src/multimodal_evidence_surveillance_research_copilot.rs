...
//!
//! Atlas feature: `AFA-worldgen-P01-F10`. This A2 agent surface makes semantic
...
pub const FEATURE_ID: &str = "AFA-worldgen-P01-F10";
pub const CONTRACT_VERSION: &str = "worldgen-multimodal-evidence-surveillance-research-copilot/1.0";
...
> {
    ...
    let qualified_set = MultimodalCopilotQualifiedEvidenceSet {
        ...
        set_id: format!(
            "worldgen-qualified-evidence-multimodal-copilot:{}",
            request.request_id
        ),
