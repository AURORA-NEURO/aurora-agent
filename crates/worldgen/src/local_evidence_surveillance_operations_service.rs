//! Local single-study operations/federation capability (`AFA-worldgen-P01-F29`).
use super::operations_support::{self};
pub use super::operations_support::{OperationsReceipt, OperationsRequest};
pub const FEATURE_ID: &str = "AFA-worldgen-P01-F29";
pub const CONTRACT_VERSION: &str = "worldgen-local-evidence-surveillance-operations/1.0";
pub const INPUT_SCHEMA: &str = "EvidenceFeed1@1";
pub const OUTPUT_SCHEMA: &str = "QualifiedEvidenceSet8@1";
pub const SCALE: &str = "local single-study";
pub fn worldgen_local_evidence_surveillance_operations_manifest() -> serde_json::Value {
...
pub fn operate_worldgen_local_evidence_surveillance(
...
mod tests {
    ...
    fn r() -> OperationsRequest {
        OperationsRequest {
            ...
            operator: "benchmark curator".into(),
    ...
    fn qualified() {
        assert_eq!(
            operate_worldgen_local_evidence_surveillance(&r())
                .unwrap()
                .disposition,
