...
//!
//! Atlas feature `AFA-worldgen-P01-F14`: an A2 workflow protocol around the
...
pub const FEATURE_ID: &str = "AFA-worldgen-P01-F14";
pub const CONTRACT_VERSION: &str = "worldgen-multimodal-evidence-surveillance-workflow-fabric/1.0";
...
pub fn multimodal_evidence_surveillance_workflow_fabric_manifest() -> CapabilityManifest {
    CapabilityManifest {
        ...
        consumers: ["preclinical neuroscientist".into(), "workflow operator".into()].into(),
...
> {
    ...
    let artifact = TypedResearchArtifact::from_payload(
        format!(
            "worldgen-multimodal-evidence-workflow:{}",
            request.workflow_id
        ),
        "application/vnd.aurora.worldgen.multimodal-research-workflow+json",
        &payload,
        vec![],
        vec![],
    )
