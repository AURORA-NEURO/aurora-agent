...
//!
//! Atlas feature: `AFA-worldgen-P01-F28`.
//!
...
pub const FEATURE_ID: &str = "AFA-worldgen-P01-F28";
pub const CONTRACT_VERSION: &str =
    "worldgen-federated-continual-evidence-surveillance-assurance/1.0";
...
pub fn worldgen_federated_continual_evidence_surveillance_assurance_manifest() -> CapabilityManifest
{
    CapabilityManifest {
...
pub fn assure_worldgen_federated_continual_evidence_surveillance(
...
use assure_worldgen_federated_continual_evidence_surveillance as assure_local_evidence_surveillance;
use worldgen_federated_continual_evidence_surveillance_assurance_manifest as influence_local_evidence_surveillance_manifest;
