...
//!
//! Atlas feature: `AFA-worldgen-P01-F08`. This contract keeps federation policy,
...
pub const FEATURE_ID: &str = "AFA-worldgen-P01-F08";
pub const CONTRACT_VERSION: &str =
    "worldgen-federated-continual-evidence-surveillance-contract-model/1.0";
...
> {
    ...
    let artifact = TypedResearchArtifact::from_payload(
        format!(
            "worldgen-federated-continual-contract:{}",
            request.request_id
        ),
        "application/vnd.aurora.worldgen.qualified-federated-evidence-set+json",
        &payload,
        Vec::new(),
        Vec::new(),
    )
