//! Federated continual operations/federation capability (`AFA-worldgen-P01-F32`).
use super::operations_support::{self};
pub use super::operations_support::{OperationsReceipt, OperationsRequest};
pub const FEATURE_ID: &str = "AFA-worldgen-P01-F32";
pub const CONTRACT_VERSION: &str =
    "worldgen-federated-continual-evidence-surveillance-operations/1.0";
pub const INPUT_SCHEMA: &str = "EvidenceFeed4@1";
pub const OUTPUT_SCHEMA: &str = "QualifiedEvidenceSet8@1";
pub const SCALE: &str = "federated continual autonomous";
pub fn worldgen_federated_continual_evidence_surveillance_operations_manifest() -> serde_json::Value
{
...
pub fn operate_worldgen_federated_continual_evidence_surveillance(
...
mod tests {
    ...
    fn r() -> OperationsRequest {
        OperationsRequest {
            ...
            operator: "bioinformatician".into(),
            scope: "federation:commons".into(),
            scale: SCALE.into(),
    ...
    fn qualified() {
        assert_eq!(
            operate_worldgen_federated_continual_evidence_surveillance(&r())
                .unwrap()
                .disposition,
