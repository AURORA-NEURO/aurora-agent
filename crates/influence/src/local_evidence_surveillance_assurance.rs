...
//!
//! Atlas feature: `AFA-influence-P01-F25`.
//!
...
pub const FEATURE_ID: &str = "AFA-influence-P01-F25";
pub const CONTRACT_VERSION: &str = "influence-local-evidence-surveillance-assurance/1.0";
...
pub fn influence_local_evidence_surveillance_manifest() -> CapabilityManifest {
    CapabilityManifest {
        ...
        outputs: vec![TypedPort { name: "qualified_evidence_set".into(), schema: "InfluenceQualifiedEvidenceSet1@1".into(), required: true }],
...
pub fn assure_local_evidence_surveillance(
