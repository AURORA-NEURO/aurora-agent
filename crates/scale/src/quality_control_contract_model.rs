//! Local single-study quality-control contract model (`AFA-scale-P07-F05`).
//!
...
pub const FEATURE_ID: &str = "AFA-scale-P07-F05";
pub const CONTRACT_VERSION: &str =
    "scale-local-single-study-quality-control-contract-model/1.0";
pub const INPUT_SCHEMA: &str = "ResearchObject3@1";
pub const OUTPUT_SCHEMA: &str = "QualityVerdict2@1";
pub const CONTENT_TYPE: &str = "application/vnd.aurora.scale-quality-verdict-2+json";
...
pub fn model_prospective_quality_control_contract(
    ...
    let artifact = TypedResearchArtifact::from_payload(
        format!("scale-quality-verdict-2:{}", request.request_id), CONTENT_TYPE, &payload, Vec::new(), Vec::new(),
