...
pub use programs::p02_evidence_knowledge::{
    ...
    monitor_prospective_knowledge, plan_federated_continual_agent, plan_glioma_workflow_recovery,
    prioritize_knowledge_frontier, promote_glioma_closed_loop_frontier,
    reconcile_glioma_claim_evidence, revise_glioma_beliefs, ActionOutcomeAssimilationError,
    ...
    FrontierActionKind, FrontierPromotionActionKind, FrontierPromotionCandidate,
    ...
    KnowledgeActionExecutionFailure, KnowledgeActionExecutor, KnowledgeActionOutcomeAssimilation,
    KnowledgeActionOutcomeAssimilationRequest, KnowledgeActionPlan, KnowledgeActionPlanDisposition,
    KnowledgeActionResultDisposition, KnowledgeActionSelectionCycle,
    KnowledgeActionSelectionCycleError, KnowledgeActionSelectionCycleRequest,
    KnowledgeActionTemplate, KnowledgeClaim, KnowledgeClaimClosure, KnowledgeClaimDisposition,
    KnowledgeClosure, KnowledgeClosureClaimDisposition, KnowledgeClosureDisposition,
    KnowledgeClosureError, KnowledgeClosureRequest, KnowledgeComponentDisposition,
    ...
    KnowledgeConsistencyRequest, KnowledgeDisposition, KnowledgeDrift, KnowledgeDriftAction,
    KnowledgeDriftDisposition, KnowledgeDriftError, KnowledgeDriftKind, KnowledgeDriftRequest,
    ...
    LocalWorkflowStep, ModalityWorkflowObservation, MultiStudyClaimDisposition,
    MultiStudyKnowledge, MultiStudyKnowledgeDisposition, MultiStudyKnowledgeError,
    MultiStudyKnowledgeRequest, MultiStudyKnowledgeRow, MultimodalKnowledgeWorkflow,
    MultimodalStudyReadiness, MultimodalWorkflowBarrier, MultimodalWorkflowBarrierKind,
    MultimodalWorkflowBranch, MultimodalWorkflowBranchKind, MultimodalWorkflowDisposition,
    MultimodalWorkflowError, MultimodalWorkflowRequest, OutcomeAssimilationDecision,
    OutcomeAssimilationDisposition, ProspectiveBeliefCalibration,
    ...
    ProspectiveKnowledgeTrend, ResearchAdmissionDisposition, ResearchAdmissionGate,
    ResearchAdmissionRoute, ResearchWorkflowAdmission, StudyClaimBinding, StudyClaimObservation,
    StudyKnowledgeSnapshot, TypedKnowledge, WorkflowAdmissionError, WorkflowAdmissionRequest,
    ...
    WorkflowRecoveryRequest, WorkflowStepObservation,
};
pub use programs::p03_multimodal_ingestion_qc::{
    ...
    execute_glioma_multimodal_ingestion_campaign, execute_glioma_multimodal_operating_cycle,
    ...
    HarmonizationVector, HarmonizedFeature, HarmonizedVector, IngestionQcAction,
    IngestionQcActionKind, LatentFactorAnalysis, LatentFactorComponent, LatentFactorDisposition,
    LatentFactorError, LatentFactorRequest, LatentFactorVector, LatentLoading, LatentScore,
    LigandReceptorPair, MissingnessAudit, MissingnessAuditDisposition, MissingnessAuditError,
    ...
    ModalityPortfolioPlan, ModalityPortfolioRequest, ModalityQualityForecast,
    ...
    MultimodalSurfaceReadiness, PairConcordanceDisposition, ProspectiveQualityError,
    ProspectiveQualityForecast, ProspectiveQualityRequest, QualityAcquisitionCandidate,
