...
pub use programs::p03_multimodal_ingestion_qc::{
    ...
    HarmonizedFeature, HarmonizedVector, LatentFactorAnalysis, LatentFactorComponent,
...
pub use programs::p04_decision_context::{
    ...
    DecisionContextRequest, DecisionContextCampaign, DecisionContextCampaignDisposition,
...
pub use programs::p06_experiment_design::{
    ...
    execute_glioma_multi_fidelity_campaign, plan_glioma_multi_fidelity_optimization,
    ...
    AdaptiveMechanismPosterior, CampaignAction, CampaignActionScore, CampaignExecutionFailure,
    CampaignExecutionRound, CampaignMechanism, CampaignMechanismPosterior, CampaignObservation,
    CampaignRound, CampaignStopReason, ClosedLoopCampaign, ClosedLoopCampaignDisposition,
    ...
    CombinationSynergyRequest, DesignAction, DesignMechanism, DesignOutcome, DoseDirection,
    DosePair, DoseResponseAnalysis, DoseResponseDisposition, DoseResponseError,
    DoseResponseObservation, DoseResponsePoint, DoseResponseRequest, EstimateSource,
    ...
    InformationDesignRequest, MultiFidelityDisposition, MultiFidelityOptimizationError,
...
pub use programs::p07_protocol_simulation::{
    ...
    GliomaEvidenceCampaignExecution, GliomaEvidenceCampaignRequest, GliomaPlannerFailure,
