...
pub use programs::p02_evidence_knowledge::{
    ...
    compile_typed_knowledge, compose_knowledge_graph, detect_glioma_knowledge_drift,
    ...
    execute_glioma_knowledge_synthesis_operating_cycle, monitor_prospective_knowledge,
    plan_federated_continual_agent, prioritize_knowledge_frontier, revise_glioma_beliefs,
    ...
    LocalWorkflowStep, MultiStudyClaimDisposition, MultiStudyKnowledge,
    MultiStudyKnowledgeDisposition, MultiStudyKnowledgeError, MultiStudyKnowledgeRequest,
    MultiStudyKnowledgeRow, ProspectiveKnowledgeAlert, ProspectiveKnowledgeDisposition,
