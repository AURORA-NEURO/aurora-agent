...
pub use programs::p05_mechanism_exploration::{
    ...
    analyze_glioma_mechanism_invariance, analyze_glioma_pathway_activity,
    ...
    MechanismIdentifiabilityRequest, MechanismInformationGain, MechanismInvariance,
...
pub use programs::p08_instrument_robotics::{
    adjudicate_glioma_assay_evidence, analyze_glioma_instrument_batch_stability,
    ...
    ChannelStabilityDisposition, DryRunInstrumentExecutor, InstrumentAction,
    InstrumentActionDecision, InstrumentActionDisposition, InstrumentAssayEvidenceAssessment,
    InstrumentAuthorization, InstrumentBatchStability, InstrumentCalibration, InstrumentCampaign,
