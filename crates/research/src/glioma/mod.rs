...
pub use programs::p08_instrument_robotics::{
    ...
    preflight_glioma_instrument, schedule_glioma_instrument_fleet, AssayEvidenceDisposition,
    ...
    InstrumentFleetBlockedTask, InstrumentFleetDisposition, InstrumentFleetResource,
    InstrumentFleetSchedule, InstrumentFleetScheduleRequest, InstrumentFleetSchedulerError,
    InstrumentFleetTask, InstrumentFleetUtilization, InstrumentInterlockSnapshot,
