...
pub use programs::p08_instrument_robotics::{
    ...
    analyze_glioma_instrument_batch_stability, analyze_instrument_calibration,
    ...
    CalibrationError, CalibrationPoint, CalibrationRequest, CalibrationRun, ChannelStability,
    ChannelStabilityDisposition, DryRunInstrumentExecutor, FederatedConsensusDisposition,
    ...
    FederatedInstrumentSite, InstrumentAction, InstrumentActionDecision,
    InstrumentActionDisposition, InstrumentAssayEvidenceAssessment, InstrumentAuthorization,
    InstrumentBatchStability, InstrumentCalibration, InstrumentCampaign,
