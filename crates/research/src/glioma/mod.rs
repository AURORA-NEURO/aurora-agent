...
pub use programs::p07_protocol_simulation::{
    ...
    fuse_glioma_protocol_evidence, materialize_glioma_protocol_branch,
    optimize_glioma_protocol_branches, plan_glioma_adaptive_workflow,
    plan_glioma_clone_continuation, plan_glioma_protocol_compensation,
    plan_glioma_research_director, plan_glioma_scientific_frontier,
