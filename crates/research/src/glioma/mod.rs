...
pub use programs::p08_instrument_robotics::{
    ...
    dry_run_instrument_executor_from_request, execute_glioma_instrument_campaign,
...
pub use programs::p09_reproducible_computation::{
    ...
    execute_glioma_computation_recovery, plan_glioma_computation_portfolio,
    ...
    RobustnessSuite, StaticGliomaComputationPlanner,
};
pub use programs::p10_interpretation_replication::{
    ...
    evaluate_glioma_dynamic_policies, execute_glioma_interpretation_operating_cycle,
