...
pub use programs::p02_evidence_knowledge::{
    compile_glioma_knowledge_actions, compile_glioma_knowledge_gaps, compile_typed_knowledge,
    ...
    BeliefRevisionError, BeliefRevisionRequest, CompiledActionDisposition, CompiledResearchAction,
    DryRunKnowledgeResolutionCampaignExecutor, FrontierActionKind, KnowledgeActionCompilerError,
    ...
    KnowledgeSynthesisOperatingCycleRequest, TypedKnowledge,
};
...
pub use programs::p07_protocol_simulation::{
    ...
    plan_glioma_clone_continuation, plan_glioma_research_director, plan_glioma_scientific_frontier,
