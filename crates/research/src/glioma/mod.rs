...
pub use programs::p02_evidence_knowledge::{
    ...
    prioritize_knowledge_frontier, reconcile_glioma_claim_evidence, revise_glioma_beliefs,
    ...
    ClaimReconciliationRow, CompiledActionDisposition, CompiledResearchAction,
