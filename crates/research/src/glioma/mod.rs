...
pub use programs::p06_experiment_design::{
    ...
    CampaignRound, CampaignStopReason, CloneBranchCoverage, ClonePerturbationCandidate,
    ...
    ContrastDesignRequest, ContrastFactor, DesignAction, DesignMechanism, DesignOutcome,
    ...
    DoseSurfaceEstimate, DoseSurfaceObservation, DryRunAdaptiveAllocationCampaignExecutor,
    DryRunExperimentOperatingCycleExecutor, DryRunGliomaExperimentFrontierExecutor,
    DryRunMultiFidelityCampaignExecutor, DryRunSequentialCampaignExecutor, EstimandContrast,
    EstimateSource, ExperimentOperatingCycle, ExperimentOperatingCycleDisposition,
    ExperimentOperatingCycleError, ExperimentOperatingCycleRequest, FidelityCalibration,
    FidelityCandidate, FidelityEstimate, FidelityLevel, FidelityObservation,
    GliomaCampaignExecutor, GliomaExperimentFrontierError, GliomaExperimentFrontierExecutor,
    ...
    GliomaFrontierStopReason, GliomaInformationDesignExecutor, InformationDesignActionScore,
    ...
    MultiFidelityOptimizationRequest, OptimizationDirection, PowerArmDecision, PowerArmObservation,
