...
pub use programs::p03_multimodal_ingestion_qc::{
    ...
    analyze_multimodal_consensus, execute_glioma_multimodal_ingestion_campaign,
    ...
    PairConcordanceDisposition, SpatialCell, SpatialCommunicationAnalysis,
...
pub use programs::p05_mechanism_exploration::{
    ...
    simulate_glioma_counterfactual_ensemble, AdaptiveMechanismAction, AdaptiveMechanismActionScore,
    ...
    AdaptiveMechanismPrediction, CounterfactualContrast, CounterfactualDirection,
...
pub use programs::p06_experiment_design::{
    ...
    execute_glioma_closed_loop_campaign, execute_glioma_multi_fidelity_campaign,
    ...
    DoseResponseRequest, DryRunAdaptiveAllocationCampaignExecutor,
    DryRunMultiFidelityCampaignExecutor, EstimateSource, FidelityCalibration, FidelityCandidate,
    FidelityEstimate, FidelityLevel, FidelityObservation, GliomaCampaignExecutor,
    GliomaInformationDesignExecutor, InformationDesignActionScore, InformationDesignDisposition,
    InformationDesignError, InformationDesignPlan, InformationDesignRequest, MultiFidelityCampaign,
...
pub use programs::p07_protocol_simulation::{
    ...
    DryRunRobustActiveLearningCampaignExecutor, GliomaActionExecutor, GliomaActionPlanner,
    ...
    GliomaResearchAutopilotRequest, GliomaResearchAutopilotRun, MechanismCampaignDisposition,
    MechanismCampaignError, MechanismCampaignExecutionDisposition, MultimodalMechanismCampaign,
    MultimodalMechanismCampaignExecution, MultimodalMechanismCampaignRequest, ProtocolDisposition,
...
pub use programs::p08_instrument_robotics::{
    ...
    execute_glioma_instrument_plan, preflight_glioma_instrument, CalibrationDisposition,
    ...
    InstrumentExecutor, InstrumentInterlockSnapshot, InstrumentOperation, InstrumentParameter,
...
pub use programs::p10_interpretation_replication::{
    ...
    execute_glioma_replication_campaign, CausalContrastAnalysis, CausalContrastDisposition,
    ...
    GliomaReplicationExecutionFailure, MediationAnalysis, MediationDisposition, MediationError,
