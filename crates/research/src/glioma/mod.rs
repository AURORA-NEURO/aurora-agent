...
pub use programs::p03_multimodal_ingestion_qc::{
    ...
    analyze_glioma_multimodal_missingness, analyze_glioma_spatial_communication,
    ...
    ModalityPortfolioPlan, ModalityPortfolioRequest, ModalityVector, MultimodalConcordance,
    ...
    SpatialCell, SpatialCommunicationAnalysis, SpatialCommunicationCell,
    ...
    SpatialPropagationTrajectory, SpatialRegistrationAnalysis, SpatialRegistrationCell,
    SpatialRegistrationDisposition, SpatialRegistrationError, SpatialRegistrationRequest,
    TemporalFusionAnalysis, TemporalFusionDisposition, TemporalFusionError, TemporalFusionRequest,
    TemporalObservation, TemporalSpatialAction, TemporalSpatialAlignment,
    TemporalSpatialAlignmentError, TemporalSpatialAlignmentRequest, TemporalSpatialDisposition,
