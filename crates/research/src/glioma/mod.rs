...
pub use programs::p03_multimodal_ingestion_qc::{
    ...
    execute_glioma_multimodal_readiness_gate, forecast_glioma_multimodal_quality,
    harmonize_glioma_multimodal_batches, plan_glioma_multimodal_portfolio,
    ...
    QualityExecutionStopReason, QualityForecastDisposition, QualityForecastObservation,
    QualityRunDisposition, QualityScheduleAlternative, QualityScheduleDisposition,
    QualityScheduleError, QualityScheduleExecutor, QualityScheduleItem, QualitySchedulePlan,
    QualityScheduleRequest, RegisteredSpatialCell, RegistrationLandmark, ReliabilityCalibration,
