...
pub use programs::p03_multimodal_ingestion_qc::{
    ...
    QualityForecastObservation, QualityIncidentSignal, QualityRemediationActionKind,
    QualityRemediationCandidate, QualityRemediationDisposition, QualityRemediationError,
    QualityRemediationPlan, QualityRemediationRequest, QualityRemediationStep, QualityRootCause,
