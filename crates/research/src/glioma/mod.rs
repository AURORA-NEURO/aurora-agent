...
pub use programs::p01_evidence_surveillance::{
    ...
    plan_glioma_evidence_acquisition, prioritize_glioma_evidence, surveil_glioma_evidence,
    triangulate_glioma_evidence, CalibrationBin, CalibrationBinDisposition,
    DryRunEvidenceRefreshCampaignExecutor, EvidenceAcquisitionCandidate,
    EvidenceAcquisitionDisposition, EvidenceAcquisitionError, EvidenceAcquisitionPlan,
    EvidenceAcquisitionRequest, EvidenceAcquisitionSelection, EvidenceAcquisitionSourceKind,
    EvidenceAcquisitionWeights, EvidenceCalibrationAnalysis, EvidenceCalibrationDisposition,
...
pub use programs::p08_instrument_robotics::{
    ...
    InstrumentPreflightPlan, InstrumentPreflightRequest,
};
pub use programs::p09_reproducible_computation::{
    ...
    ComputationExecutionStopReason, ComputationOperation, ComputationPlacementAssignment,
    ...
    ComputationTask, ComputationTaskDisposition, ComputationTaskResult, ComputationWorkerProfile,
...
pub use programs::p10_interpretation_replication::{
    ...
    evaluate_glioma_dynamic_policies, execute_glioma_replication_campaign,
    ...
    AdaptiveFrontierRequest, AdaptiveResearchFrontier, AdaptiveTarget, CausalContrastAnalysis,
    ...
    DynamicPolicyScoreDisposition, DynamicPolicyTrajectory, GliomaReplicationAction,
