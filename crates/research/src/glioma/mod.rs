...
pub use programs::p06_experiment_design::{
    ...
    plan_glioma_replication, plan_glioma_robust_active_learning, plan_glioma_sequential_design,
    ...
    PanelAction, PanelMechanism, PanelOutcome, PowerArmDecision, PowerArmObservation,
    PowerDecisionKind, PowerReestimationDisposition, PowerReestimationError, PowerReestimationPlan,
    PowerReestimationRequest, ReplicationObservation, ReplicationPlan, ReplicationPlanDisposition,
