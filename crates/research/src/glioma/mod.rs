...
pub use programs::p03_multimodal_ingestion_qc::{
    ...
    MultimodalIngestionExecutionFailure, MultimodalReadinessError, MultimodalReadinessRequest,
    ...
    QualityAcquisitionCandidate, QualityForecastDisposition, QualityForecastObservation,
    QualityScheduleAlternative, QualityScheduleDisposition, QualityScheduleError,
    QualityScheduleItem, QualitySchedulePlan, QualityScheduleRequest, RegisteredSpatialCell,
