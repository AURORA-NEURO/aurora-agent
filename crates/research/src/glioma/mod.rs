...
pub use programs::p02_evidence_knowledge::{
    ...
    monitor_prospective_knowledge, plan_federated_continual_agent, prioritize_knowledge_frontier,
    revise_glioma_beliefs, AdmittedResearchAction, AutonomousGapCycle,
