...
pub use programs::p03_multimodal_ingestion_qc::{
    ...
    plan_glioma_multimodal_portfolio, plan_glioma_multimodal_quality_schedule,
    register_glioma_spatial_samples, surveil_glioma_multimodal_drift, AlignedSampleState,
    ...
    QualityForecastObservation, QualityIncidentSignal, QualityRootCause,
