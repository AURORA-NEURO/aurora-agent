...
pub use programs::p02_evidence_knowledge::{
    ...
    prioritize_knowledge_frontier, revise_glioma_beliefs, ActionOutcomeAssimilationError,
    ...
    BeliefRevisionRequest, BridgedKnowledgeCandidate, ClaimExperimentClosure,
    ClaimExperimentClosureDisposition, ClaimExperimentClosureError, ClaimExperimentClosureRequest,
    ClaimExperimentDisposition, ClaimExperimentResult, CompiledActionDisposition,
