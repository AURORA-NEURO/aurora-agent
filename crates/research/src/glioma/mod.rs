...
pub use programs::p10_interpretation_replication::{
    ...
    execute_glioma_replication_closure_campaign, execute_glioma_validation_replication_campaign,
    interpret_glioma_replication_closure, plan_glioma_adaptive_research_frontier,
    plan_glioma_replication_closure_frontier, plan_glioma_validation_replication_gate,
    ...
    ClosureInterpretationRun, DryRunAdaptiveInterpretationPlanner,
