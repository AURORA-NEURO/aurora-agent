...
pub use programs::p03_multimodal_ingestion_qc::{
    ...
    harmonize_glioma_multimodal_batches, register_glioma_spatial_samples, AlignedSampleState,
    ...
    ConsensusError, ConsensusRequest, DropoutModalitySignal, DropoutScenario,
