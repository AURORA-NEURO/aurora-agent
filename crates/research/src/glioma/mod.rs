...
pub use programs::p06_experiment_design::{
    ...
    plan_glioma_information_design, AdaptiveAllocation, AdaptiveAllocationActionKind,
    ...
    InformationDesignError, InformationDesignPlan, InformationDesignRequest,
...
pub use programs::p07_protocol_simulation::{
    ...
    DryRunGliomaProtocolExecutor, GliomaActionExecutor, GliomaActionPlanner,
    ...
    GliomaProtocolExecutor, ProtocolDisposition, ProtocolExecution, ProtocolExecutionDisposition,
    ...
    ProtocolTaskResult, ResourceUtilization, ScheduleEntry, StaticGliomaActionPlanner,
...
pub use programs::p10_interpretation_replication::{
    ...
    analyze_glioma_trajectories, analyze_replication_meta_analysis,
