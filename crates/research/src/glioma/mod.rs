...
pub use programs::p03_multimodal_ingestion_qc::{
    ...
    SpatialPropagationRequest, SpatialPropagationTrajectory, RegisteredSpatialCell,
    RegistrationLandmark, SampleRegistration, SampleRegistrationDisposition,
    SpatialRegistrationAnalysis, SpatialRegistrationCell, SpatialRegistrationDisposition,
    SpatialRegistrationError, SpatialRegistrationRequest,
...
pub use programs::p06_experiment_design::{
    ...
    DoseDirection, DosePair, DoseResponseAnalysis,
    DoseResponseDisposition, DoseResponseError, DoseResponseObservation, DoseResponsePoint,
    DoseResponseRequest, DryRunAdaptiveAllocationCampaignExecutor, EstimandContrast,
...
pub use programs::p08_instrument_robotics::{
    ...
    InstrumentPreflightRequest, InstrumentAssayEvidenceAssessment,
};
