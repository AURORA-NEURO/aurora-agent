...
pub fn glioma_research_engine_manifest() -> CapabilityManifest {
    CapabilityManifest {
        ...
        consumers: [
            ...
            "spatial state propagation analyst".into(),
            ...
            "knowledge-resolution campaign controller".into(),
            ...
            "glioma intent-to-computation workflow compiler".into(),
            "cross-family glioma interpretation gate".into(),
            "active-learning assay scheduler".into(),
            "active-learning campaign executor".into(),
            "robust active-learning scientist".into(),
            "robust active-learning campaign executor".into(),
            "preclinical transportability analyst".into(),
            "glioma computation portfolio planner".into(),
            "glioma computation portfolio executor".into(),
            "glioma computation campaign controller".into(),
            "glioma replication campaign controller".into(),
            "multimodal mechanism campaign controller".into(),
            "multimodal mechanism campaign executor".into(),
            "autonomous glioma mission scientist".into(),
            "cross-program research mission operator".into(),
            "multi-fidelity campaign experimentalist".into(),
            "federated benchmark campaign controller".into(),
            "reproducibility replay campaign steward".into(),
        ]
        .into(),
        behavior: "compile an adaptive, checkpoint-oriented glioma campaign, continuously diff local evidence snapshots into prioritized review actions, prioritize the current evidence snapshot by recency, state pressure, quality, reproducibility, and cross-modality/model coverage debt into concrete refresh, resolution, measurement, revalidation, coverage, and replication actions, execute bounded evidence-refresh rounds through a caller-owned local executor, rerun surveillance from each typed returned record, preserve stale, unknown, contradictory, negative, missing-coverage, retry, budget, and no-progress states, compile typed knowledge claims from every local evidence snapshot, rank the claim frontier by coverage debt, contradiction, uncertainty, support, and workflow leverage, execute bounded claim-resolution rounds through a caller-owned local executor, recompile knowledge from returned records after every round, preserve contradiction and negative results instead of fabricating support, compile a bounded decision context from that typed knowledge, select a dependency-safe action portfolio, execute context actions through a caller-owned local adapter, recompile knowledge and decision context from every returned evidence row, and retain omission, contradiction, negative, retry, budget, and no-progress states, execute bounded multimodal-ingestion/QC rounds that turn missing modality/model coverage, excluded observations, coordinate/unit defects, and missingness into typed local ingestion actions, recompute QC from every returned observation, and preserve raw-local and de-identified boundaries, admit typed adapters for that queue and execute its dependency closure through the local action executor while preserving missing-adapter and policy blocks, compile typed claims and evidence-gap actions, select the next dependency-safe batch with a bounded beam-search portfolio optimizer over value, cost, diversity, and prerequisite closure, compile residual-likelihood mechanism discriminators into typed assay candidates ranked by information per cost, execute that selected portfolio through a caller-owned local action executor with bounded retries and dependency-aware halting, run a finite-horizon adaptive mechanism policy that updates integer posteriors from local observations, scores Gini information gain and lower-tail effects, and beam-selects the next assay sequence under risk, feasibility, redundancy, and budget gates, run bounded multi-round computation campaigns that replan typed DAG candidates from returned local task outcomes while preserving replay-keyed cache and hard cost/duration gates, run an autonomous replication/interpretation campaign that recomputes cross-site replication, inverse-uncertainty meta-analysis, influence, heterogeneity, and model-system transportability after each typed local study result and ranks bounded follow-up actions, run a bounded observation-driven autonomous campaign that asks a caller-owned planner for the next typed assay or analysis round and replans only from returned outcomes, adapt a cross-program scientific mission frontier across evidence, mechanism, experiment, computation, and replication candidates using explicit stage/model/modality coverage, contradiction pressure, information gain, and uncertainty gates, execute a closed-loop multi-fidelity campaign that recalibrates screening-to-mechanistic/validation transfer bias and reliability from returned paired observations, keeps prior/transfer/neighbourhood estimates distinct from measured results, and admits higher-fidelity conditions only after lower-fidelity support gates, decompose preclinical mediator, total, direct, and indirect effects with deterministic influence bounds before mechanism interpretation, calibrate multi-fidelity screening-to-validation surrogates and choose a cost/risk-aware next batch with an uncertainty-carrying beam search, use a deterministic mechanism-aware kernel surrogate to choose the next assay from local and nearby observations while widening uncertainty for contradiction, execute an admitted full preclinical program through caller-owned local stage executors, drive closed-loop assay rounds through a caller-owned executor that replans from returned observations, execute feasible resource-scheduled protocols through a caller-owned local worker with dependency checks, typed artifacts, bounded retries, and fail-closed partial results, detect instrument-control drift before assay admission, compile a serialized instrument/robotics preflight from calibration, interlocks, typed operation parameters, operator authorization, and risk/duration budgets, execute that admitted plan through a caller-owned gateway with authorization and live-interlock rechecks before each action, bounded retries, local artifact validation, and emergency-stop halting for unsafe or partial effects, compare and batch-harmonize declared multimodal vectors before consensus, extract robust complete-case latent states with convergence and reconstruction gates, build same-lineage spatial niches and ligand-receptor communication enrichments against a lineage-marginal null, propagate spatial state over same-sample cell neighborhoods with lineage-aware coupling, convergence bounds, and hotspot ranking, compare and cluster multimodal vectors, discriminate competing mechanisms against local features and rank information-gain assays, propagate signed activating/inhibiting mechanism networks with convergence gates, simulate signed node perturbations against baseline fixed points to rank downstream assay targets while preserving low-confidence and non-convergent states, evaluate each candidate intervention across a declared model ensemble with prior-weighted lower-tail robustness and a risk/cost/feasibility-aware portfolio gate, score candidate assays with integer-only expected Gini information reduction and compile a bounded local batch, update mechanism posteriors from each returned categorical outcome and replan adaptive assay campaigns through a caller-owned executor, plan closed-loop assay rounds from posterior information gain, expected effect, feasibility, cost, risk, and replicate ceilings, fit longitudinal trajectory, discrete-state transition, causal-contrast, stratified-overlap-adjusted, dose-response, combination-synergy, replication-meta-analysis, and hidden-confounding sensitivity effects, allocate the next bounded assay replicate batch from conservative Beta-posterior effect probabilities, compare aggregate federated benchmark outcomes with robust site consensus, autonomously rank and execute bounded aggregate-only federated benchmark follow-up actions, execute dependency-aware reproducibility replay tasks against expected artifact hashes, and stress-test endpoint effects under deterministic omission batteries; every unresolved, contradictory, underpowered, heterogeneous, budget, locality, and approval state routes to an explicit hold or abstain branch".into(),
        ...
        outputs: vec![
            ...
            TypedPort {
                name: "glioma_autonomous_campaign".into(),
                schema: "GliomaAutonomousCampaign1@1".into(),
                required: false,
            },
            TypedPort {
            ...
            TypedPort {
                name: "glioma_adaptive_mechanism_policy".into(),
                schema: "GliomaMechanismAdaptivePolicy1@1".into(),
                required: false,
            },
            TypedPort {
                name: "glioma_causal_mediation".into(),
                schema: "GliomaCausalMediation1@1".into(),
                required: false,
            },
            TypedPort {
                name: "glioma_multi_fidelity_optimization".into(),
                schema: "GliomaMultiFidelityOptimization1@1".into(),
                required: false,
            },
            TypedPort {
            ...
            TypedPort {
                name: "glioma_protocol_execution".into(),
                schema: "GliomaProtocolExecution1@1".into(),
                required: false,
            },
            TypedPort {
            ...
            TypedPort {
                name: "glioma_computation_portfolio_execution".into(),
                schema: "GliomaComputationPortfolioExecution1@1".into(),
                required: false,
            },
            TypedPort {
            ...
            TypedPort {
                name: "glioma_replication_campaign".into(),
                schema: "GliomaReplicationCampaign1@1".into(),
                required: false,
            },
            TypedPort {
            ...
            TypedPort {
                name: "glioma_multi_fidelity_campaign".into(),
                schema: "GliomaMultiFidelityCampaign1@1".into(),
                required: false,
            },
            TypedPort {
            ...
            TypedPort {
                name: "glioma_closed_loop_campaign_execution".into(),
                schema: "GliomaClosedLoopCampaignExecution1@1".into(),
                required: false,
            },
            TypedPort {
            ...
            TypedPort {
                name: "glioma_multimodal_mechanism_campaign".into(),
                schema: "GliomaMultimodalMechanismCampaign1@1".into(),
                required: false,
            },
            TypedPort {
                name: "glioma_multimodal_mechanism_campaign_execution".into(),
                schema: "GliomaMultimodalMechanismCampaignExecution1@1".into(),
                required: false,
            },
            TypedPort {
            ...
            TypedPort {
                name: "glioma_spatial_communication".into(),
                schema: "GliomaSpatialCommunication1@1".into(),
                required: false,
            },
            TypedPort {
                name: "glioma_spatial_state_propagation".into(),
                schema: "GliomaSpatialStatePropagation1@1".into(),
                required: false,
            },
            TypedPort {
            ...
            TypedPort {
                name: "glioma_mechanism_counterfactual".into(),
                schema: "GliomaMechanismCounterfactual1@1".into(),
                required: false,
            },
            TypedPort {
                name: "glioma_mechanism_ensemble_counterfactual".into(),
                schema: "GliomaMechanismEnsembleCounterfactual1@1".into(),
                required: false,
            },
            TypedPort {
                name: "glioma_robust_intervention_portfolio".into(),
                schema: "GliomaRobustInterventionPortfolio1@1".into(),
                required: false,
            },
            TypedPort {
            ...
            TypedPort {
                name: "glioma_evidence_priority".into(),
                schema: "GliomaEvidencePriority1@1".into(),
                required: false,
            },
            TypedPort {
                name: "glioma_evidence_campaign_execution".into(),
                schema: "GliomaEvidenceCampaignExecution1@1".into(),
                required: false,
            },
            TypedPort {
                name: "glioma_knowledge_resolution_campaign".into(),
                schema: "GliomaKnowledgeResolutionCampaign1@1".into(),
                required: false,
            },
            TypedPort {
            ...
            TypedPort {
                name: "glioma_decision_context_campaign".into(),
                schema: "GliomaDecisionContextCampaign1@1".into(),
                required: false,
            },
            TypedPort {
            ...
            TypedPort {
                name: "glioma_computation_workflow".into(),
                schema: "GliomaComputationWorkflow1@1".into(),
                required: false,
            },
            TypedPort {
                name: "glioma_interpretation_synthesis".into(),
                schema: "GliomaInterpretationSynthesis1@1".into(),
                required: false,
            },
            TypedPort {
                name: "glioma_active_learning".into(),
                schema: "GliomaActiveLearning1@1".into(),
                required: false,
            },
            TypedPort {
            ...
            TypedPort {
                name: "glioma_robust_active_learning".into(),
                schema: "GliomaRobustActiveLearning1@1".into(),
                required: false,
            },
            TypedPort {
            ...
            TypedPort {
                name: "glioma_transportability_analysis".into(),
                schema: "GliomaTransportabilityAnalysis1@1".into(),
                required: false,
            },
            TypedPort {
            ...
            TypedPort {
                name: "glioma_replay_campaign".into(),
                schema: "GliomaResearchObjectReplayCampaign1@1".into(),
                required: false,
            },
        ],
