...
pub use glioma::{
    ...
    execute_glioma_adaptive_information_campaign, execute_glioma_adaptive_mechanism_campaign,
    ...
    plan_glioma_multi_fidelity_optimization, plan_glioma_research_director,
    ...
    protocol_request_from_experiment_design, qualify_evidence, register_glioma_spatial_samples,
    ...
    EstimandContrast, EstimateSource, EvidenceAcquisitionCampaign,
    ...
    EvidenceGatedResearchDisposition, EvidencePriorityAction, EvidencePriorityActionKind,
    ...
    EvidenceTriangulationRequest, ExperimentArm, ExperimentDesign, ExperimentRequest, FeatureValue,
    ...
    KnowledgeFrontierScore, KnowledgeFrontierWeights, KnowledgeGapClaimMapping,
    KnowledgeGapCompilerError, KnowledgeGapCompilerRequest, KnowledgeGapPortfolio,
    KnowledgeGapPortfolioDisposition, KnowledgeGapSourceTemplate, KnowledgePathDisposition,
    KnowledgeRelation, KnowledgeRelationKind, KnowledgeRequest, KnowledgeResolutionCampaign,
