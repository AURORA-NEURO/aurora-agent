...
pub use glioma::{
    ...
    ClaimExperimentClosureRequest, ClaimExperimentDisposition, ClaimExperimentResult, ClaimGate,
    ClaimGateDisposition, ClaimNextAction, ClonalEdge, ClonalEvolutionDisposition,
