...
pub use glioma::{
    ...
    SensitivityPoint, SensitivityRequest, SpatialCell, SpatialNiche, SpatialNicheAnalysis,
    ...
    TrajectoryRequest, TypedKnowledge, UnitContrast, UnitTrajectory, UnitTrajectoryDisposition,
