...
pub const FEATURE_ID: &str = "AFA-factory-P32-F12";
pub const CONTRACT_VERSION: &str =
    "factory-federated_continual_lease_fencing_integrity_research_copilot/1.0";
pub fn federated_continual_lease_fencing_integrity_research_copilot_manifest() -> serde_json::Value
{
    manifest(
        FEATURE_ID,
        CONTRACT_VERSION,
...
pub fn qualify_federated_continual_lease_fencing_integrity_research_copilot(
