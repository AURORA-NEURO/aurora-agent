...
//! many of the fifty-three are process*, nothing noticed when two crates disagreed, and nothing
...
//! under `crates/` or `docs/`. A register listing fifty-three uncovered ids would mark all
//! fifty-three covered and take the headline to 100% — a number produced entirely by the document
...
//!
//! Fifty-three modules, seventy-eight recorded verdicts. By primary verdict:
//!
//! ```text
//! process                37   councils, cadence, appeals, a dashboard somebody reads
//! foreign artifact        7   Python, TypeScript, two GitHub Actions, and a workflow file
