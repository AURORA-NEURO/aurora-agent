...
pub const FEATURE_ID: &str = "AFA-megafactory-P32-F09";
pub const CONTRACT_VERSION: &str =
    "megafactory-local_factory_lineage_integrity_research_copilot/1.0";
pub fn local_factory_lineage_integrity_research_copilot_manifest() -> serde_json::Value {
    manifest(FEATURE_ID, CONTRACT_VERSION, "local", "research_copilot")
}
pub fn qualify_local_factory_lineage_integrity_research_copilot(
