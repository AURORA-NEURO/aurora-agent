...
pub const FEATURE_ID: &str = "AFA-megafactory-P32-F14";
pub const CONTRACT_VERSION: &str =
    "megafactory-multimodal_factory_lineage_integrity_workflow_fabric/1.0";
pub fn multimodal_factory_lineage_integrity_workflow_fabric_manifest() -> serde_json::Value {
    manifest(
        FEATURE_ID,
        CONTRACT_VERSION,
        "multimodal",
...
pub fn qualify_multimodal_factory_lineage_integrity_workflow_fabric(
