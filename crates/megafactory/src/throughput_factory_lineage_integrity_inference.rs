...
pub const FEATURE_ID: &str = "AFA-megafactory-P32-F03";
pub const CONTRACT_VERSION: &str = "megafactory-throughput_factory_lineage_integrity_inference/1.0";
pub fn throughput_factory_lineage_integrity_inference_manifest() -> serde_json::Value {
    manifest(FEATURE_ID, CONTRACT_VERSION, "throughput", "inference")
}
pub fn qualify_throughput_factory_lineage_integrity_inference(
