...
pub use federated_continual_bounded_evolution_assurance::{
    assure_mutation_federated_bounded_evolution, mutation_federated_bounded_evolution_manifest,
    MutationEvolutionEvidenceState, MutationEvolutionProposal7, MutationEvolutionReceipt10,
    MutationEvolutionReceipt10Artifact, MutationEvolutionRequest8, MutationFederatedEvolutionError,
...
pub use federated_publication_release_copilot::{
    ...
    MutationPublicationReleaseReceipt9, PublicationReleaseDisposition, PublicationReleaseError,
    PublicationReleaseRequest6, ValidatedResearchRun4,
...
pub use federated_resource_discovery_control_plane::{
    mutation_federated_resource_discovery_manifest, operate_mutation_federated_resource_discovery,
    operate_mutation_federated_resource_discovery_json,
    validate_mutation_federated_resource_discovery_json, EndpointStatus,
    MutationPeerResourceSummary4, MutationResourceDiscoveryError, MutationResourceEndpoint4,
    MutationResourceNeed4, QualifiedResource8, QualifiedResourceSet8, ResourceEvidenceState,
...
pub use knowledge_representation_federated_control_plane::{
    mutation_knowledge_federated_control_manifest, operate_mutation_knowledge_federated_control,
    MutationKnowledgeCandidate, MutationKnowledgeDecision, MutationKnowledgeFederatedControlError,
    MutationKnowledgeFederatedControlRequest, MutationKnowledgeFederatedReceipt,
...
pub fn standard_suite() -> Vec<Mutation> {
    let mut suite = vec![
        Mutation::new(
            "rename-subjects",
            MutationKind::RenameSubjects { prefix: "X".into() },
        ),
