...
impl Server {
    ...
    fn developer_platform_status(&self, arguments: &Value) -> Result<Value, String> {
        ...
        let mut result = json!({
            ...
            "limitations": [
                "the full Python SDK surface, generated domain clients, gRPC client, and GitHub Actions remain outside this Rust check; typescript/ and python/prism_sdk provide bounded API and authoring clients, but are not executed by this Rust check",
    ...
    fn developer_delivery_audit(&self, arguments: &Value) -> Result<Value, String> {
        ...
        Ok(json!({
            ...
            "limitations": [
                "the workflow does not implement the full Python SDK surface, generated domain clients, biological Python adapters, gRPC clients, GitHub Actions, CI runners, or authoring UIs; REST/event access is provided by the bounded bioprism-api gateway and typescript/ client",
