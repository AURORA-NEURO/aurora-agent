...
pub use research_contracts::{
    ...
    resource_discovery_contract_v2_json, simulate_protocol_matrix_json,
    synthesize_federated_continuum_json, validate_autonomy_batch_receipt_json,
    ...
    DESIGN_FRONTIER_TOOL, EVALUATION_OBSERVABILITY_TOOL, FEDERATED_CONTINUAL_RETRIEVAL_TOOL,
