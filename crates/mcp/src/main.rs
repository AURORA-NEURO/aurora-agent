            ...
            "-h" | "--help" => {
                println!(
                    ...
                    contradiction_review,\n\
                     ...
                     developer_platform_status, capability_discover, agent_mission, developer_workbench, developer_delivery_audit, safety_posture, security_redteam_simulate, weave_protocol_catalog, world_index,\n\
