            ...
            "-h" | "--help" => {
                println!(
                    ...
                    contradiction_review,\n\
                     ...
                     adapter_local_evidence_surveillance_research_workbench, adapter_multimodal_evidence_surveillance_research_workbench, runtime_effect_check, runtime_tape_verify, runtime_execution_simulate, runtime_workflow_execute, onco_boundary_check,\n\
