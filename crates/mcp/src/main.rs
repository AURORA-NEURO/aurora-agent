            ...
            "-h" | "--help" => {
                println!(
                    ...
                    contradiction_review,\n\
                     ...
                     glioma_decision_branch_plan, glioma_decision_branch_campaign_execute, glioma_adaptive_decision_branch_campaign_execute, glioma_decision_action_plan, glioma_knowledge_frontier, glioma_knowledge_gap_compile, glioma_autonomous_gap_cycle, glioma_knowledge_synthesis_operating_cycle,\n\
