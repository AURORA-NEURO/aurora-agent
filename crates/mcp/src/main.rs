            ...
            "-h" | "--help" => {
                println!(
                    ...
                    contradiction_review,\n\
                     ...
                     glioma_multimodal_harmonize, glioma_multimodal_latent_factors, glioma_spatial_niches, glioma_spatial_communication, glioma_state_transition_analyze, glioma_causal_sensitivity,\n\
