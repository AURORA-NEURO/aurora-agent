            ...
            "-h" | "--help" => {
                println!(
                    ...
                    contradiction_review,\n\
                     ...
                     glioma_multimodal_harmonize, glioma_multimodal_latent_factors, glioma_multimodal_graph_fusion, glioma_spatial_niches, glioma_spatial_communication, glioma_spatial_state_propagation, glioma_state_transition_analyze, glioma_transportability_analyze, glioma_protocol_branch_optimize, glioma_protocol_autonomous_execute, glioma_protocol_evidence_surface, glioma_protocol_execute, glioma_protocol_compensation, glioma_action_portfolio_execute, glioma_causal_sensitivity,\n\
