            ...
            "-h" | "--help" => {
                println!(
                    ...
                    contradiction_review,\n\
                     ...
                     evaluation_reproduction_check, evaluation_trajectory_check, evaluation_observability_card, research_release_validate, instrument_preflight, multimodal_harmonize, analysis_qualify, protocol_matrix_simulate,\n\
