            ...
            "-h" | "--help" => {
                println!(
                    ...
                    contradiction_review,\n\
                     ...
                     workspace_capabilities, brain_model_select, brain_prompt_assemble, brain_plan, brain_bandit_select, brain_bandit_update, brain_outcome_record, repository_catalog, repository_bundle, repository_impact\n\
