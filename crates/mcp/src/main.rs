            ...
            "-h" | "--help" => {
                println!(
                    ...
                    contradiction_review,\n\
                     ...
                     oracle_reference_panel, oracle_missingness, bioeval_reference_audit, bioeval_acquisition_audit, bioeval_grounding_audit, bioeval_estimand_audit, bioeval_evaluator_audit, bioeval_plane_audit, bioeval_metamorphic_audit,\n\
