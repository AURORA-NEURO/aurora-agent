            ...
            "-h" | "--help" => {
                println!(
                    ...
                    contradiction_review,\n\
                     ...
                     evaluation_reproduction_check, evaluation_trajectory_check, evaluation_observability_card, federated_evaluation_consensus, resource_workbench_discover, resource_discovery_contract_v2, governance_research_release_compile, release_assurance_harness, protocol_assurance_harness, federated_multimodal_assurance, research_release_validate, research_release_batch_validate, instrument_preflight, multimodal_harmonize, multimodal_replication_evaluate, quality_drift_evaluate, design_frontier_evaluate, autonomy_batch_admit, workflow_batch_execute, analysis_qualify, protocol_matrix_simulate,\n\
