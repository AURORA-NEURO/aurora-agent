            ...
            "-h" | "--help" => {
                println!(
                    ...
                    glioma_scientific_frontier_execute,\n\
                     ...
                     glioma_multimodal_quality_remediation,\n\
                     glioma_multimodal_quality_recovery,\n\
                     glioma_mechanism_discriminate, glioma_mechanism_bayesian_update, glioma_mechanism_state_filter, glioma_mechanism_state_smoother, glioma_mechanism_calibrate,\n\
