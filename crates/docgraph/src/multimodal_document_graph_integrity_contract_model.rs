...
pub const FEATURE_ID: &str = "AFA-docgraph-P32-F06";
pub const CONTRACT_VERSION: &str =
    "docgraph-multimodal_document_graph_integrity_contract_model/1.0";
pub fn multimodal_document_graph_integrity_contract_model_manifest() -> serde_json::Value {
    manifest(FEATURE_ID, CONTRACT_VERSION, "multimodal", "contract_model")
}
pub fn qualify_multimodal_document_graph_integrity_contract_model(
