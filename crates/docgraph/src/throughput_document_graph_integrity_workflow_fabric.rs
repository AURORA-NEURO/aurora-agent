...
pub const FEATURE_ID: &str = "AFA-docgraph-P32-F15";
pub const CONTRACT_VERSION: &str =
    "docgraph-throughput_document_graph_integrity_workflow_fabric/1.0";
pub fn throughput_document_graph_integrity_workflow_fabric_manifest() -> serde_json::Value {
    manifest(
        FEATURE_ID,
        CONTRACT_VERSION,
        "throughput",
...
pub fn qualify_throughput_document_graph_integrity_workflow_fabric(
