//! Computational-execution assurance harness.
//!
//! Atlas feature: `AFA-cli-P12-F28`.
//!
...
pub const FEATURE_ID: &str = "AFA-cli-P12-F28";
pub const CONTRACT_VERSION: &str = "cli-federated-continual-computational-execution-assurance/1.0";
