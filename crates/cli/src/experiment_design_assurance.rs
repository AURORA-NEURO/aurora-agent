...
pub const FEATURE_ID: &str = "AFA-cli-P09-F28";
pub const CONTRACT_VERSION: &str = "cli-federated-continual-experiment-design-assurance/1.0";
...
pub fn assure_experiment_design(
    ...
    let artifact = TypedResearchArtifact::from_payload(
        format!("cli-experiment:{}", q.request_id),
