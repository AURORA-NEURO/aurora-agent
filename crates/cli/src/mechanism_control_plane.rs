//! Federated continual mechanism-exploration control plane.
//!
//! Atlas feature: `AFA-cli-P08-F32`.
//! This control plane admits typed candidate manifests and emits only digest-only control
