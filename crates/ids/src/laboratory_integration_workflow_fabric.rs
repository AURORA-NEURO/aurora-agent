//! Federated laboratory-integration workflow fabric (`AFA-ids-P11-F16`).
//!
//! This A2 control-plane contract compiles instrument and action attestations into a
...
pub const FEATURE_ID: &str = "AFA-ids-P11-F16";
pub const CONTRACT_VERSION: &str =
    "ids-federated-continual-laboratory-integration-workflow-fabric/1.0";
pub const INPUT_SCHEMA: &str = "LaboratoryIntegrationRequest6@1";
pub const OUTPUT_SCHEMA: &str = "LaboratoryIntegrationReport9@1";
pub const CONTENT_TYPE: &str = "application/vnd.aurora.laboratory-integration-report-9+json";
...
pub fn integrate_laboratory_workflow(
...
mod tests {
    ...
    #[test]
    fn manifest_is_a2() {
        assert_eq!(laboratory_integration_manifest()["autonomy_tier"], "A2");
    }
    #[test]
    fn nominal_qualifies_without_hardware() {
        let r = integrate_laboratory_workflow(&req()).unwrap();
    ...
    fn interlock_blocks() {
        ...
        assert_eq!(
            integrate_laboratory_workflow(&r).unwrap().disposition,
            "blocked"
        );
    }
    #[test]
    ...
    fn duplicate_instrument_rejected() {
        ...
        assert!(integrate_laboratory_workflow(&r).is_err());
    }
}
