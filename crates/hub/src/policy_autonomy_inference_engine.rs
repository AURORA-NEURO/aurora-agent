//! Prospective high-throughput policy/autonomy inference engine (`AFA-hub-P19-F03`).
//!
...
pub const FEATURE_ID: &str = "AFA-hub-P19-F03";
pub const CONTRACT_VERSION: &str =
    "hub-prospective-high-throughput-policy-autonomy-inference-engine/1.0";
pub const INPUT_SCHEMA: &str = "ActionAndAuthority3@1";
pub const OUTPUT_SCHEMA: &str = "PolicyReceipt1@1";
pub const CONTENT_TYPE: &str = "application/vnd.aurora.hub-policy-receipt-1+json";
